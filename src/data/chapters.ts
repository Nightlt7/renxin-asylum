...
export const chapters: Chapter[] = [
  {
    ...
    advanceQuestion: {
      ...
      answer: '崔诣',
      hints: [
        '记忆引入中提到，对众人而言你叫叶臻，但你的父亲姓崔。',
        '父亲给你取名时，用的是”崔”姓与”诣”字——“诣”意为到达、造诣。',
        '回顾记忆引入最后一段：你的真名是”崔诣”。',
        '答案就是两个字：崔诣。你的真名是”崔诣”。',
      ],
    },
  ...
  },
  {
    ...
    advanceQuestion: {
      question: '刘师姐短信中提到，仁馨通过什么方式把药送到病房？（提示：不是人工配送）',
      answer: '机器臂/机械臂/机器手臂/机器人',
      hints: [
        '刘师姐短信描述：仁馨药局不需要护士去拿药，药物会自动送到病房。',
        '这是一种自动化机械装置，可以自动抓取药物并配送到指定位置。',
        '这个装置在工厂和仓库里很常见，仁馨用它替代了人工配药。',
        '答案：机器臂（或机械臂、机器手臂）。',
      ],
    },
    audioClues: [
  ...
  },
  {
    ...
    advanceQuestion: {
      question: '电梯 IC 卡权限记录中，崔哲金被取消了哪一层楼的权限？',
      answer: '4楼/四楼/4f/4F/四层/4层',
      hints: [
        'IC 卡拼图还原的权限记录中，有一条写着”2017.06.20 · 崔 / 4F 取消”。',
        '”4F”就是第 4 层楼的意思，崔哲金从此无法进入 4 楼病房区。',
        '这说明曹怀敬在 2017 年 6 月开始排挤崔哲金，限制他的活动范围。',
        '答案就是：4楼（或 4F、四楼、四层）。',
      ],
    },
    puzzleId: 'p_dossier',
  ...
  },
  {
    ...
    advanceQuestion: {
      question: '密码盘解密得到的英文单词是什么？它代表了什么？',
      answer: 'brain/大脑组织/大脑',
      hints: [
        '明信片摩尔斯电码解出"304 fridge brain"，信里夹层的密码盘给出了进一步确认。',
        '密码盘密文 EUDLQ，内圈左转 3 格，每个字母回退 3 位：E→b, U→r, D→a, L→i, Q→n。',
        '连起来是一个 5 字母英文单词，代表人体最重要的器官。',
        '答案：brain（大脑组织），指的是袁枝被摘除并藏在 304 冰箱里的大脑组织。',
      ],
    },
  ...
  },
  {
    ...
    advanceQuestion: {
      ...
      answer: '崔哲金坠楼/袁枝推崔哲金坠楼/崔哲金被推下楼/坠楼/推下天台',
      hints: [
        '时间线起点：何秀文听到三个人起夜，第一个是姚欢。',
        '随后：罗昆山开锁取卡 → 柴靖替换视频 → 早操放出袁枝 → 袁枝纵火。',
        '最后：袁枝带崔哲金上天台，逼问大脑组织下落未果后将其推下。',
        '答案：崔哲金坠楼（或袁枝推崔哲金坠楼、推下天台）。',
      ],
    },
    puzzleId: 'p_timeline',
